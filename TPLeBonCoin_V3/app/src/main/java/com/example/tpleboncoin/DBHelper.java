...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE = "create table " + TABLE_NAME + "(" + _id + " INTEGER PRIMARY KEY AUTOINCREMENT, " + TITLE + " TEXT NOT NULL, " + ADDRESS + " TEXT, " + IMAGE + " TEXT, " + TEL + " TEXT);";
    ...
    public AdModel getById(long id) {
        ...
        String tel = data.getString(data.getColumnIndexOrThrow(TEL));

        return new AdModel(title, address, image, tel);
    }
}
